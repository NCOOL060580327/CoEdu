...
public class MemberController {
    ...
    @PatchMapping(value = "/profile/profile-image", consumes = {MediaType.MULTIPART_FORM_DATA_VALUE})
    ...
    public ResponseEntity<MemberResponse> updateNickName(
        ...
        MemberResponse updatedMember = memberService.updateNickName(newNickName, userDetails.getMember());
        return ResponseEntity.status(HttpStatus.OK).body(updatedMember);
    }
