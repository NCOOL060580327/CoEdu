...
public class BoardController {
    ...
    public ResponseEntity<BoardResponseDto> updateBoard(
        ...
        BoardResponseDto updatedBoard = boardService.updateBoard(requestDto, boardId, userDetails.getMember());
    ...
    public ResponseEntity<List<BoardUserResponseDto>> findBoardUsers(
        ...
        List<BoardUserResponseDto> members = boardService.findBoardUsersById(boardId, userDetails.getMember());
    ...
    @GetMapping("/{boardId}")
    public ResponseEntity<BoardResponseDto> getBoardDetails(
            @PathVariable Long boardId
    ) {
